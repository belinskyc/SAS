...
::: notes
Our code is vital to decision making... we need to communicate with our code (partners, legal)
:::
...
::: notes
The number is flexible – want to separate code in a intuitive manner

Packages are often not transparent and TidyVerse encourages run-on sentences.

Having others test your code, like reading your papers, is vital.
:::
